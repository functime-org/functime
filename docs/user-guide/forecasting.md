...
`functime` supports both [`expanding_window_split`](https://functime-org.github.io/functime/ref/cross-validation/#functime.cross_validation.expanding_window_split)
and [`sliding_window_split`](https://functime-org.github.io/functime/ref/cross-validation/#functime.cross_validation.sliding_window_split) for backtesting and cross-validation.
