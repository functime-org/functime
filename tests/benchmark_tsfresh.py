...
_FUNC_PARAMS_BENCH  = [
    ...
    (func_feat.energy_ratios, ts_feat.energy_ratio_by_chunks, {"n_chunks": 10}, {"param": {}}),
    ...
    (func_feat.linear_trend, ts_feat.linear_trend, {}, {"params": [{"attr": "slope"}, {"attr": "intercept"}, {"attr": "rss"}]}),
